...
export function Fruits(){
    ...
    return(
        ...
        <div>
            <div className="row ml-0 mr-0 col-lg-12 container-fluid bg-warning p-5 pl-0 pr-0">
                <div className=" column bg-white rounded p-2">
                    ...
                    <div className="col-lg-5 pb-5 pl-5 ml-4 mt-2">
                    <img className="col-lg-12 banana" src={banana}/><br/>
                    <button className="ml-4 btn bg-primary text-white" onClick={()=>setbananaincre(bananaincre+1)}>Eat Banana</button>
                    </div>
                    </div>
                </div>
