            ...
            <div className="container-fluid background p-5">
                ...
                <div className= "bg-white whitebox">
                    <div className="row p-5">
                        ...
                        <div className="log">
                        <img className="loginimg" src={system}/>
                        </div>
                        </div>   
                            <div className="col-lg-6  text-center">
                                ...
                                <button className="btn btn-primary button p-3 mt-5"> LOGIN</button>
                               <p className="mt-3 ">Forgot: <a href="" className="text-primary">User name/Password ?</a></p>
                               <a href="" className="text-primary">Create your Account</a>
                            </div>
