...
export function Notification(){
    return(
        <div>
            ...
            <div className="bg-primary  rounded-lg text-white text-left p-3 m-3 ">  
                <h2><FontAwesomeIcon icon={faCircleCheck}/> Information Message</h2>
            </div>
           
            <div className="bg-success rounded-lg text-white text-left p-3 m-3 ">  
                <h2><FontAwesomeIcon icon={faCircleCheck}/> Success Message</h2>
            </div>
          
            <div className="bg-warning rounded-lg text-white text-left p-3 m-3">  
                <h2><FontAwesomeIcon icon={faBell}/> Warning Message</h2>
            </div>
            
            <div className="bg-danger rounded-lg text-white text-left p-3 m-3">  
